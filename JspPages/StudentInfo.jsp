<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@ page import="java.util.List" %>
     <%@ page import="VOLayers.StudentVO" %>
    <%-- <%@ page import="Handlers.StudentVO" %> --%>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<%@taglib uri="http://java.sun.com/jstl/core_rt" prefix="c"%>
<html>
<head>
<title>Student Information | Style Demo</title>
...
<div class="wrapper row1">
  <div id="header" class="clear">
    <div class="fl_left">
      <h1><a href="../index.html">Student Information</a></h1>
    ...
    <div id="topnav">
      ...
      <li><a href="../index.html">HOME</a></li>
					 <li ><a href="newstudent.jsp">REGISTRATION</a></li>
                                        <li class="active"><a href="StudentInfo.jsp">STUDENT DETAILS</a></li>
